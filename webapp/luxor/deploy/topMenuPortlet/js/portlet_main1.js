...
var currentPageId = 'N201404170106584111002';

$(document).ready(function() {
	var contentId = 'C201511261411130271155';
	var mzTop_param = 'pageId=N201404170106584111002&contentId=C201511261411130271155';
			...
			default : 
				...
				if ($('#'+_targetDIV+' > ul > li').size() == 0) {
					...
					if(_zoneId == 'mzTop') {
						...
						_targetVal += ' style="z-index:100000; top:32px"></ul>';
					} else {
						_targetVal += ' style="z-index:100000;margin-top:0px"></ul>';
					}
