...
(function($) {
	...
	$.fn.attachment = function(options) {
		...
		html += '<img id="uploadClearButton" src="' + options.contextRoot + '/ref/jquery/image/clear.jpg" width="57" height="24" border="0" style="padding-bottom:1px;cursor:pointer;vertical-align:bottom;" />\n';
		html += '</div>\n';
