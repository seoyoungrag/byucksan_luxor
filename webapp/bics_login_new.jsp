...
<div class="condiv" onclick="forDisplay();">
...
<table border="0" align="center" cellpadding="0" cellspacing="5" style="margin-top:135px">
        ...
        <div class="down_box" id="programs">
	         <table border="0" cellspacing="3" cellpadding="0">
	              ...
	              <tr>
	                ...
	                <td class="down_title02">(546kb)</td>
	                <td><a href="/ep/luxor/ref/plugins/ACUBEFileCtrl(V2,1,9,33).exe" download style="border:1px solie #f00;"><img src="/ep/luxor/ref/img/login_down_btn.jpg" style="cursor:pointer;" alt="설치"/></a></td>
	              </tr>
	             <!--  <tr>
...
<!-- <OBJECT id="xxxObj" CLASSID="CLSID:AA309817-9D1F-4328-9F63-1F611160A4E5" codebase="/ep/luxor/ref/plugins/ACUBEFileCtrl(V2,1,9,30).cab" width=0 height=0 onError="alert('설치안됨');"></OBJECT> -->
...
<OBJECT id="acubefilectrlcontrol" CLASSID="CLSID:B84E12B0-B248-4371-A95A-EC943670DCFC" codebase="/ep/luxor/ref/plugins/ACUBEFileCtrl(V2,1,9,33).cab" onError="check('ACUBEFILECTRL.AcubeFileCtrlCtrl.1')" width=0 height=0 ></OBJECT>
