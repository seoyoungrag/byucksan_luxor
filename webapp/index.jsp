...
function getSchListbySelectDay(dateText,schSelectedStatus){
	...
	getSchData(sendDateData,schSelectedStatus);
...
function goApprovalDirection(docId, publishId){
	...
	if(approvalTabVal == 0){ // 대기함
		lobCode = 'LOB003';
		linkUrl = "<%=appUrl%>/ep/app/approval/selectAppDoc.do?docId="+docId+"&lobCode="+lobCode;
		...
		lobCode = 'LOB031';
		linkUrl = '<%=appUrl%>/ep/app/approval/selectAppDoc.do?publishId='+publishId+'&docId='+docId+'&lobCode='+lobCode;
			...
			<div class="luxor-inner-body" >
				...
				<div id="left" type="zone" class="luxor-leftmain">
					...
					<div class="div_box_left">
						...
						<div class="box_list_ptv_leftw">
							<ul>
								<li class="list01"><span class="ptv_spanleft">전자메일</span><span class="ptv_spanright">0</span></li>
				...
				<div id="content" type="zone" class="luxor-content" style="width:720PX;">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabTable">
						<tr>
							<td height="26" class="tabmenu01">
								<ul>
									<li class="tab_on01" id="tab00" onClick="bbsTabClick(1)">전사공지</li>
							...
							<td class="tab_bg"><img src="<%=contextPath%>/luxor/ref/img/pluse.png" id="bbsmore" alt="더보기"/></td>
						</tr>
					</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabTable">
						<tr>
							...
							<td class="tab_bg"><img src="<%=contextPath%>/luxor/ref/img/pluse.png" alt="더보기"/></td>
						</tr>
					</table>
					<div class="box_list_con">
					...
					<div class="div_box newbbsBox">
						<div class="tit_box"><span class="tit">최근게시물</span><span class="more"><img src="<%=contextPath%>/luxor/ref/img/pluse.png" alt="더보기"/></span></div>
						<div class="box_list">
				...
				<div id="right" type="zone" class="luxor-right">
					...
					<div class="div_box blogBox">
						<div class="tit_box"><span class="tit">벽산블로그</span><span class="more"><img src="<%=contextPath%>/luxor/ref/img/pluse.png" alt="더보기"/></span></div>
						<div class="box_list">
					...
					<div class="div_box occasionBox">
						<div class="tit_box"><span class="tit">임직원동정</span><span class="more"><img src="<%=contextPath%>/luxor/ref/img/pluse.png" alt="더보기"/></span></div>
