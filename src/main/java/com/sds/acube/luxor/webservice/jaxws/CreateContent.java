...
@XmlRootElement(name = "createContent", namespace = "http://webservice.luxor.acube.sds.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createContent", namespace = "http://webservice.luxor.acube.sds.com/")
