...
@XmlRootElement(name = "removeContent", namespace = "http://webservice.luxor.acube.sds.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeContent", namespace = "http://webservice.luxor.acube.sds.com/")
