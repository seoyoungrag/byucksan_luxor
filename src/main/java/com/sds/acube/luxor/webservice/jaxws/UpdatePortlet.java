...
@XmlRootElement(name = "updatePortlet", namespace = "http://webservice.luxor.acube.sds.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updatePortlet", namespace = "http://webservice.luxor.acube.sds.com/")

public class UpdatePortlet {
