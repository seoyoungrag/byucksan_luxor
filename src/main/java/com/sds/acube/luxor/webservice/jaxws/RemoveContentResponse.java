...
@XmlRootElement(name = "removeContentResponse", namespace = "http://webservice.luxor.acube.sds.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeContentResponse", namespace = "http://webservice.luxor.acube.sds.com/")
