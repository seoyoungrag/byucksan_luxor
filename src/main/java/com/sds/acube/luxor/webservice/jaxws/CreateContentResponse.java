...
@XmlRootElement(name = "createContentResponse", namespace = "http://webservice.luxor.acube.sds.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createContentResponse", namespace = "http://webservice.luxor.acube.sds.com/")
