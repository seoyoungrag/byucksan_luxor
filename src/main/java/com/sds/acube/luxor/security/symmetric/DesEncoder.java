...
public class DesEncoder implements SecurityEncoder {
	...
	public String encode(String data) throws Exception {
		return encodeDes(data, algorithm);
	}

	public String encode(String data, String algorithm) throws Exception {
		return encodeDes(data, algorithm);
	}

	private String encodeDes(String data, String algorithm) {
		try {
			Cipher cipher = null;
